...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        //CompletableFuture<HolderLookup.Provider> lookupProvider = event.getLookupProvider(); //for tags
        ...
        // generator.addProvider(event.includeServer(), new ModGlobalLootModifiersProvider(packOutput)); //for loot like chests and mobs
    }
}
